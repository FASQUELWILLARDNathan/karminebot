...
def start_lolvalrl_task(bot, DB_PASSWORD):
    ...
    async def check_upcoming_matches():
        ...
        query = """
            ...
            AND winner = ''
            AND (series = 'VALORANT Champions Tour' OR series = 'LEC' OR series = 'Rocket League Championship Series')
            ORDER BY date ASC
        """
    ...
    if not check_upcoming_matches.is_running():
        check_upcoming_matches.start()