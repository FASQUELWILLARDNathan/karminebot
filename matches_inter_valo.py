...
def update_matches():
    ...
    'conditions': '([[opponent::Karmine Corp]] OR [[opponent::Karmine Corp Blue Stars]] OR [[opponent::Karmine Corp GC]]) AND [[series::!VALORANT Champions Tour]] AND [[series::!Game Changers]] AND [[series::!VALORANT Challengers Leagues]]',
