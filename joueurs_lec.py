...
params = {
    ...
    'conditions': '([[teampagename::Karmine_Corp]] OR [[teampagename::GIANTX]] OR [[teampagename::Team_BDS]] OR [[teampagename::G2_Esports]] OR [[teampagename::KOI]] OR [[teampagename::Rogue]] OR [[teampagename::SK_Gaming]] OR [[teampagename::Team_Heretics]] OR [[teampagename::Team_Vitality]] OR [[teampagename::Fnatic]]) AND [[type::player]] AND [[status::Active]] AND [[pagename::!TraYtoN]] AND [[pagename::!Skain]]',
    'limit': 50,
    'offset': 0
}

# Fonction pour mettre à jour la table des joueurs
def update_players():
